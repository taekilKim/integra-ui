    ...
    <Card className="p-24 md:p-40 flex flex-col gap-32 w-full max-w-960 mx-auto border border-integra-gray-200 shadow-integra rounded-16 bg-white">
      <Playground className="flex-col md:flex-row gap-32 items-center justify-center">
        <div className="flex flex-col items-center gap-12">
          <p className="fs-12 font-bold text-integra-gray-400 uppercase tracking-1">단일 토글</p>
          <Toggle size={size} variant={variant} aria-label="굵게 토글">
            <TextB className="h-16 w-16" />
          </Toggle>
        </div>
        
        <div className="flex flex-col items-center gap-12">
          <p className="fs-12 font-bold text-integra-gray-400 uppercase tracking-1">다중 선택 그룹</p>
        ...
        <div className="flex flex-col items-center gap-12">
          <p className="fs-12 font-bold text-integra-gray-400 uppercase tracking-1">단일 선택 그룹</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-24 pt-24 border-t border-integra-gray-100">
        <div className="space-y-8">
          <Label className="fs-12 font-semibold text-integra-gray-500 uppercase tracking-1">크기</Label>
          <select 
            className="w-full h-40 rounded-8 border border-integra-gray-200 bg-white px-12 fs-14"
            value={size}
            onChange={(e) => setSize(e.target.value)}
          >
            <option value="default">기본 (40px)</option>
            <option value="sm">소형 (32px)</option>
            <option value="lg">대형 (48px)</option>
          </select>
        </div>
        <div className="space-y-8">
          <Label className="fs-12 font-semibold text-integra-gray-500 uppercase tracking-1">변형</Label>
          <select
            className="w-full h-40 rounded-8 border border-integra-gray-200 bg-white px-12 fs-14"
            value={variant}
      ...
      <div className="rounded-12 bg-integra-gray-900 p-24 font-mono fs-14 leading-24 text-white">
        <code className="block text-integra-gray-500 mb-8">// 단일 토글</code>
        <code>&lt;Toggle size="{size}" variant="{variant}"&gt;...&lt;/Toggle&gt;</code>
        <br/><br/>
        <code className="block text-integra-gray-500 mb-8">// 토글 그룹</code>
