...
export default function RadioGroupDocsPage() {
  const designTokens = [
    ...
    { property: "Indicator (지시자)", class: "w-10 h-10", value: "10px" },
    ...
    <div className="space-y-64 pb-120">
      <div className="space-y-16">
        ...
        <p className="fs-20 text-integra-gray-500 leading-32 tracking--1">
          ...
          기본 원형 스타일부터 버튼 형태의 확장 패턴까지 아토믹 조립을 지원합니다.
        </p>
      </div>
      ...
      <Tabs defaultValue="overview" className="space-y-48">
        ...
        <TabsContent value="radio-button" className="space-y-48">
          <section className="space-y-16">
          ...
          <section className="space-y-24">
            ...
            <p className="fs-14 text-integra-gray-600">라디오 원자를 버튼 형태로 시각화하는 조립법입니다.</p>
            <div className="rounded-12 bg-integra-gray-900 p-24 overflow-x-auto font-mono fs-14 leading-24 text-white shadow-2xl">
              <pre>
{`<RadioGroup defaultValue="daily" className="flex p-4 bg-integra-gray-50 rounded-12 gap-4">
  <div className="flex-1">
    <RadioGroupItem value="daily" id="daily" className="sr-only peer" />
    <Label htmlFor="daily" className="flex justify-center items-center h-32 rounded-8 fs-13 
