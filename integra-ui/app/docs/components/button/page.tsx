...
/**
 * [Integra UI - Button Document SAI Standard Version]
 * 모든 수치는 4px/2px 그리드 및 수치형 토큰을 사용하며,
 * 고도화된 CodeBlock 컴포넌트를 통해 사용법을 안내합니다.
 */
export default function ButtonDocsPage() {
  ...
  const usageCode = `<div className="flex gap-16">
  <Button appearance="default" variant="default" size="default">
    Primary Button
  </Button>
  <Button appearance="outlined" variant="default" size="medium">
    Outlined Button
  </Button>
</div>`;
