  ...
  return (
    <div className="space-y-48 pb-80">
      <div className="space-y-16">
        ...
        <h1 className="fs-40 font-bold leading-48 tracking--4">Badge</h1>
        <p className="fs-20 text-muted-foreground leading-32 tracking--1 max-w-600">
          상태, 카테고리, 태그 등을 시각적으로 강조하여 표시합니다. 텍스트 흐름을 방해하지 않는 정교한 크기로 설계되었습니다.
        </p>
      </div>
      <hr className="border-slate-100" />
      <section className="space-y-16">
        <h2 className="fs-24 font-bold tracking--2 leading-32">Playground</h2>
        <BadgeDemo />
      </section>
      <section className="space-y-16 p-32 bg-slate-50 rounded-16 border border-slate-100">
        <h2 className="fs-20 font-bold leading-24 tracking--1">Atomic Design Note</h2>
        <div className="space-y-12 fs-15 text-slate-600 leading-24 tracking--1">
      ...
      <section className="space-y-16">
        <h2 className="fs-24 font-bold tracking--2 leading-32">Usage</h2>
        <div className="rounded-8 bg-slate-950 p-20 overflow-x-auto font-mono fs-14 leading-24 text-white">
